...
set "CLOVER_PATH=%WORKSPACE%\Clover"
...
set "CLOVER_DSC=%CLOVER_PATH%\Clover.dsc"
set "CLOVER_LOG=%CLOVER_PATH%\clover.log"
...
set "CLOVER_BUILD_CMD=build -s -p __CLOVER_DSC__ -a X64 -t %MYTOOLCHAIN% -b RELEASE -n %NUMBER_OF_PROCESSORS% -j __CLOVER_LOG__"
