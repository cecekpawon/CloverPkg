...
set "CUSTOM_CONF_PATH=%CLOVER_PATH%\Conf"
set "CLOVER_BUILD_PATH=%WORKSPACE%\Build\CloverPkg\RELEASE_%MYTOOLCHAIN%"
...
if exist "%CUSTOM_CONF_PATH%\target.txt" (
  set "CONF_PATH=%CUSTOM_CONF_PATH%"
)
