...
IFlushWithPageBreak (
  ...
  CHAR16    *Pos, *LineStart, LineEndChar;
...
IInput (
  ...
  BOOLEAN         Done, InsertMode;
  INTN            Row;
  UINTN           Column, StartColumn, Update, Delete, Len, StrPos, Index,
                  LineLength, TotalRow, SkipLength, OutputLength, TailRow, TailColumn;
  EFI_INPUT_KEY   Key;
